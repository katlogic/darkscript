// Generated by ToffeeScript 1.5.0
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.icedHasContinuation = function() {
      var _ref2;
      return !!this.icedContinuationBlock || ((_ref2 = this.icedPrequels) != null ? _ref2.length : void 0);
    };
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileNode = function(o) {
      var chld, code, codes, node, top, _i, _len, _ref2;
      this.tab = o.indent;
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        ...
        if (node instanceof Block) {
          ...
          node.front = true;
          code = node.compile(o);
          if (!node.isStatement(o)) code = "" + this.tab + code + ";";
          codes.push(code);
        } else {
  ...
  exports.Literal = Literal = (function(_super) {
    ...
    Literal.prototype.compileNode = function(o) {
      var code, _ref2;
      code = this.isUndefined ? o.level >= LEVEL_ACCESS ? '(void 0)' : 'void 0' : this.value === 'this' ? ((_ref2 = o.scope.method) != null ? _ref2.bound : void 0) ? o.scope.method.context : this.value : this.value.reserved ? "\"" + this.value + "\"" : this.icedLoopFlag && this.icedIsJump() ? this.compileIced(o) : this.value;
      if (this.isStatement()) {
  ...
  exports.Return = Return = (function(_super) {
    ...
    function Return(expr, auto) {
      ...
      if (expr == null) expr = [];
      if (expr.length == null) {
        if (expr && !expr.unwrap().isUndefined) expr = [expr];
      }
    ...
    Return.prototype.compileNode = function(o) {
      ...
      if (this.icedHasAutocbFlag) {
        ...
        return this.tab + ("return" + [this.expression[0] ? " " + (this.expression[0].compile(o, LEVEL_PAREN)) : void 0] + ";");
      }
    };
  ...
  exports.Value = Value = (function(_super) {
    ...
    Value.prototype.icedCpsRotate = function() {
      var nv, p, v, _i, _len, _ref2, _results;
      if (!this.properties.length) {
      ...
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        p = _ref2[_i];
        if ((p.index != null) && (v = this.icedCpsExprRotate(p.index))) {
  ...
  exports.Obj = Obj = (function(_super) {
    ...
    Obj.prototype.toSlot = function(i) {
      var prop, _i, _len, _ref2, _results;
      _ref2 = this.properties;
      _results = [];
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        prop = _ref2[_i];
        if (prop instanceof Assign) {
          ...
          _results.push((prop.toSlot(i)).addAccess(prop));
        } else {
          _results.push(void 0);
        }
      }
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.hoistDirectivePrologue = function() {
      ...
      while ((node = expressions[index]) && node instanceof Comment || node instanceof Value && node.isString() || node instanceof IcedRuntime) {
        ++index;
      }
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var code, exprs, f, i, idt, lhs, lit, name, p, param, params, r, ref, rhs, splats, uniqs, val, wasEmpty, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      if (this.icedNodeFlag && !this.icedgen) {
        ...
        this.body.unshift(new Assign(lhs, rhs, null, {
          icedlocal: true
        }));
      }
  ...
  exports.Param = Param = (function(_super) {
    ...
    function Param(name, value, splat) {
      ...
      if (_ref2 = (name = (_ref3 = this.name) != null ? _ref3.unwrapAll().value : void 0), __indexOf.call(STRICT_PROSCRIBED, _ref2) >= 0) {
  ...
  exports.While = While = (function(_super) {
    ...
    While.prototype.icedWrap = function(d) {
      ...
      if (d.step) continue_block_inner.unshift(d.step);
  ...
  exports.Defer = Defer = (function(_super) {
    ...
    Defer.prototype.transform = function(o) {
      ...
      if (!o.release) assignments.push(ln_assign);
  ...
  exports.Await = Await = (function(_super) {
    ...
    Await.prototype.transform = function(o) {
      ...
      if (n = (_ref3 = this.parentFunc) != null ? _ref3.traceName() : void 0) {
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.compileIced = function(o, d) {
      var a1, a2, a3, a4, a5, b, body, condition, empty_arr, guard, iname, init, ival, key, key_lit, key_val, keys, keys_access, keys_len, keys_val, kval, len, len_rhs, len_val, loop_body, loop_keys, loop_source, pre_body, ref, ref_val, ref_val_copy, rop, rvar, scope, source_access, step;
      if (!this.icedNodeFlag) return null;
      body = d.body;
      condition = null;
      init = [];
      ...
      if (this.object) {
        ...
        rop = this.source.base.exclusive ? '<' : '<=';
        condition = new Op(rop, this.name, this.source.base.to);
        init = [new Assign(this.name, this.source.base.from)];
        if (this.step != null) {
          step = new Op("+=", this.name, this.step);
        } else {
  ...
  exports.If = If = (function(_super) {
    ...
    If.prototype.isStatement = function(o) {
      var _ref2;
      return (o != null ? o.level : void 0) === LEVEL_TOP || this.bodyNode().isStatement(o) || ((_ref2 = this.elseBodyNode()) != null ? _ref2.isStatement(o) : void 0) || this.icedHasContinuation();
    };
