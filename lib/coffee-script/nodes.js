...
(function() {
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.transform = function() {
      var blocks, dest, moved, next, node, _ref2;
      dest = [];
    ...
    Block.prototype.move = function(dest) {
      var idx, node, _i, _len, _ref2;
      _ref2 = this.expressions;
      for (idx = _i = 0, _len = _ref2.length; _i < _len; idx = ++_i) {
        node = _ref2[idx];
        if (this.async) {
          if (!(node instanceof AsyncCall)) {
            this.expressions[idx] = node.move(dest);
          }
        }
      }
      this.async = false;
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.move = function(dest) {
      ...
      this.value = this.value.move(dest);
      this.async = false;
      return this;
    };
  ...
  exports.Op = Op = (function(_super) {
    ...
    Op.prototype.move = function(dest) {
      var _ref4, _ref5;
      if ((_ref4 = this.first) != null ? _ref4.async : void 0) {
        this.first = this.first.move(dest);
      }
      if ((_ref5 = this.second) != null ? _ref5.async : void 0) {
        this.second = this.second.move(dest);
      }
      this.async = false;
      return this;
    };
