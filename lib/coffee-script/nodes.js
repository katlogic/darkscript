...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.toString = function(idt, name) {
      ...
      tree = '\n' + idt + name;
      _ref2 = ['autocb', 'async', 'bound', 'cross', 'moved', 'no_results', 'generated', 'need_return'];
  ...
  exports.While = While = (function(_super) {
    ...
    While.prototype.asyncCompileNode = function(o, info) {
      ...
      if (flow.next && !this.results_id) {
        ...
        done_fn = new Assign(new Literal(names.done), new Code([], new Block(done_body), 'boundfunc', flow));
        done_fn.moved = true;
      }
      if (this.results_id) {
      ...
      if (info.stepPart) {
        ...
        step_fn = new Assign(new Literal(step_name), new Code([], new Block([info.stepPart, ret = new Call(new Literal(names.body))])));
      ...
      body_fn = new Assign(new Literal(names.body), code = new Code([], new Block([ifPart = new If(info.condPart, info.body).addElse(ret = new Call(new Literal(done)))]), 'boundfunc', {
        next: step_name,
        "return": flow["return"],
        "break": done,
        "continue": step_name
