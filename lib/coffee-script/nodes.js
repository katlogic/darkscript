...
(function() {
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (isValue = this.variable instanceof Value) {
        ...
        if (this.isFunctionDeclareation() && !o.scope.check(this.variable.base.value) && this.underCodeBlock) {
  ...
  exports.If = If = (function(_super) {
    ...
    If.prototype.move = function(dest, next_body) {
      var body, call, next, _i, _len, _ref4, _ref5, _ref6, _ref7;
      if (next_body == null) {
        next_body = null;
      }
      if (!this.async) {
      ...
      if ((_ref6 = this.condition) != null ? _ref6.async : void 0) {
