...
(function() {
  ...
  exports.While = While = (function(_super) {
    ...
    While.prototype.asyncCompileNode = function(o, info) {
      var answer, blocks, body_fn, call_body, done, done_fn, flow, ifPart, name, names, ret, _i, _len, _ref4;
      if (this.flow) {
        o.flows.push(this.flow);
      }
      flow = o.flows.last();
      ...
      body_fn = new Assign(new Literal(names.body), new Code([], new Block([ifPart = new If(this.condition, info.body).addElse(ret = new Call(new Literal(done)))]), 'boundfunc', {
        next: names.body,
        "return": flow["return"],
        "break": done,
        "continue": names.body
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.asyncCompileNode = function(o, info) {
      var answer, blocks, body_fn, call_body, done, done_fn, flow, ifPart, name, names, ret, step_fn, _i, _len, _ref4;
      if (this.flow) {
        o.flows.push(this.flow);
      }
      flow = o.flows.last();
      ...
      body_fn = new Assign(new Literal(names.body), new Code([], new Block([ifPart = new If(new Literal(info.condPart), info.body).addElse(ret = new Call(new Literal(done)))]), 'boundfunc', {
        next: names.step,
        "return": flow["return"],
        "break": done,
        "continue": names.step
