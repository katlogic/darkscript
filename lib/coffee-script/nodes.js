...
(function() {
  ...
  exports.Op = Op = (function(_super) {
    ...
    Op.prototype.compileRegexp = function(o) {
      return new Assign(new Value(new Literal('__matches')), new Call(new Value(this.first, [new Access(new Literal('match'))]), [this.second])).compileToFragments(o, LEVEL_OP);
    };
