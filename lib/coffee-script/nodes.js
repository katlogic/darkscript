...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.makeReturn = function(res) {
      ...
      if (res) {
        ...
        return new Return([me], this.autocb);
      }
    };
    ...
    Base.prototype.setFlags = function(scopes) {
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.makeReturn = function(res) {
      ...
      if (len === 0 && this.autocb) {
        this.expressions.push(new Return([], this.autocb));
        return this;
      }
      while (len--) {
    ...
    Block.prototype.sync = function() {
      var forward, idx, next, node, _i, _len, _ref2, _ref3;
      _ref2 = this.expressions;
      for (idx = _i = 0, _len = _ref2.length; _i < _len; idx = ++_i) {
        ...
        if (node instanceof Await) {
          ...
          node = node.sync(next);
          this.expressions.splice(idx, 1, node);
          break;
        } else if (node.async && ((_ref3 = node.constructor.name) === 'For' || _ref3 === 'If')) {
          next = this.pop_next(idx);
          if (next.isEmpty()) {
            next = null;
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.asyncCompileNode = function(o, info) {
      var body, body_code, body_name, cond_check, init, init_code, init_name, scope, step, step_code, step_name;
      scope = o.scope;
      cond_check = new If(new Value(new Literal(info.cond)), new Return([new Call(new Literal('autocb'))]));
      info.body.autocb = true;
      info.body.setFlags([this]);
      info.body.sync(this);
      info.body.unshift(cond_check);
      body_name = new Value(new Literal(scope.freeVariable('body')));
      body_code = new Code([new Param(new Literal('autocb'))], info.body, 'boundfunc');
      ...
      step_code = new Code([], new Block([new Value(new Literal(info.step)), new Call(body_name)]));
      step_code.noReturn = true;
      step = new Assign(step_name, step_code);
      return Block.wrap([new Literal(info.init), step, body, new Call(body_name)]).compileNode(o);
    };
  ...
  exports.If = If = (function(_super) {
    ...
    If.prototype.sync = function(next) {
      var placeholder, _ref4, _ref5, _ref6;
      if (this.autocb) {
        if ((_ref4 = this.elseBody) == null) {
          this.elseBody = new Block([]);
        }
      ...
      this.elseBody.autocb = this.autocb;
      if ((_ref6 = this.elseBody) != null ? _ref6.async : void 0) {
        this.elseBody.isChain = false;
      }
  ...
  exports.Await = Await = (function(_super) {
    ...
    Await.prototype.children = ['call'];

    Await.prototype.compileNode = function(o, block) {};
    ...
    Await.prototype.sync = function(next) {
      var assign, assigns, call, def, pos, _i, _len, _ref4;
      if (!next) {
        return Await.__super__.sync.apply(this, arguments);
      }
      call = this.call;
      call.omit_return = true;
      next = next.code;
