...
(function() {
      ...
      while (node = this.expressions.shift()) {
        if (node.async) {
          ...
          if (node instanceof AsyncCall) {
            ...
            this.expressions = [];
          } else if (node instanceof For && this.expressions.length) {
  ...
  exports.Value = Value = (function(_super) {
    ...
    Value.prototype.get_names = function(names) {
      ...
      } else if (typeof (_base = this.base).hasProperties === "function" ? _base.hasProperties() : void 0) {
        return null;
      ...
      while (n--) {
        if (this.properties[n].async) {
          for (i = _i = 0; 0 <= n ? _i <= n : _i >= n; i = 0 <= n ? ++_i : --_i) {
            ...
            this.properties[i].value = obj.value.move(dest);
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.move = function(dest) {
      ...
      if ((_ref5 = this.guard) != null ? _ref5.async : void 0) {
        this.guard = this.guard.move(dest);
      }
  ...
  exports.If = If = (function(_super) {
    ...
    If.prototype.move = function(dest, next_body) {
      var body, call, next, _i, _len, _ref4, _ref5, _ref6;
      if (next_body == null) {
        next_body = null;
      }
      if (!this.async) {
