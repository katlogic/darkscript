...
(function() {
      ...
      return this.traverse({
        from_parent: function(self, parent) {
          ...
          if (self instanceof Block) {
            ...
            Base.scope = self;
          } else if (!(parent instanceof Obj) && self instanceof Assign && (names = self != null ? self.variable.get_names() : void 0)) {
            (_ref2 = Base.scope.vars).push.apply(_ref2, names);
          }
          if ((_ref3 = self.autocb) == null) {
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileNode = function(o) {
      var answer, compiledNodes, fragments, index, node, nodes, top, v, _i, _j, _len, _len1, _ref2, _ref3;
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      flow = this.cross ? o.flows.clone(this.flow) : this.flow || {};
      o.flows.push(flow);
      o.sharedScope || (o.sharedScope = this.async);
      ...
      if (!((wasEmpty || this.noReturn) && !o.flows.last().next)) {
  ...
  exports.Op = Op = (function(_super) {
    ...
    Op.prototype.move_cond = function(dest, fn) {
      ...
      body_block.move();
      return Base.move_ac(dest, body_block, false);
    };
