...
(function() {
  var Access, Arr, Assign, Await, Base, Block, Call, Class, Closure, Code, CodeFragment, Comment, Defer, Existence, Extends, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, last, locationDataToString, merge, multident, puts, some, starts, throwSyntaxError, unfoldSoak, utility, _ref, _ref1, _ref2, _ref3,
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileNode = function(o) {
      var answer, compiledNodes, fragments, index, node, top, v, _i, _j, _len, _len1, _ref2, _ref3;
      this.tab = o.indent;
    ...
    Block.prototype.sync = function() {
      var code, fn, idx, name, next, node, _i, _len, _ref2;
      _ref2 = this.expressions;
      for (idx = _i = 0, _len = _ref2.length; _i < _len; idx = ++_i) {
        ...
        if (node instanceof Await) {
          ...
          if (next.isEmpty()) {
            ...
            code = new Code([], next);
            code.sync();
            name = new Value(new Literal(this.uid()));
            fn = new Assign(name, code);
            this.expressions.splice(idx, 0, fn);
          }
          node.sync(name);
          break;
    ...
    Block.prototype.pop_next = function(idx) {
      return Block.wrap(this.expressions.splice(idx + 1));
    };
  ...
  exports.If = If = (function(_super) {
    ...
    If.prototype.sync = function(name) {
  ...
  exports.Await = Await = (function(_super) {
    ...
    Await.prototype.sync = function(next) {
      var assign, assigns, call, cb, def, pos, _i, _len, _ref4;
      call = this.call;
      next.autocb = this.autocb;
      call.omit_return = true;
