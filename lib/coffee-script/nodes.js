...
(function() {
  ...
  exports.Base = Base = (function() {
    ...
    Base.prototype.toString = function(idt, name) {
      ...
      tree = '\n' + idt + name;
      _ref2 = ['autocb', 'async', 'bound', 'cross', 'moved', 'no_results'];
      ...
      return this.traverse({
        from_parent: function(self, parent) {
          ...
          if (self instanceof Block) {
            ...
            Base.scope = self;
          } else if (self instanceof Assign && !self.context && (names = self != null ? self.variable.get_names() : void 0)) {
      ...
      while (node = this.expressions.shift()) {
        if (node.async) {
          ...
          if (node instanceof AsyncCall) {
            ...
            this.expressions = [];
          } else if ((node instanceof For || node instanceof While) && this.expressions.length) {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      ...
      flow = this.cross ? flow = o.flows.clone() : {};
      if (this.flow) {
        flow = extend(flow, this.flow);
      }
      o.flows.push(flow);
  ...
  exports.Switch = Switch = (function(_super) {
    ...
    Switch.prototype.compileNode = function(o) {
      var block, body, break_code, cond, conditions, expr, flow, fragments, i, idt1, idt2, _i, _j, _len, _len1, _ref4, _ref5, _ref6;
      flow = o.flows.last();
      idt1 = o.indent + TAB;
      ...
      for (i = _i = 0, _len = _ref4.length; _i < _len; i = ++_i) {
        ...
        break_code = this.wrapped ? "" + flow.next + "()" : 'break';
