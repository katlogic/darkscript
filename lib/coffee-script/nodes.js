...
(function() {
  var $flows, $verbose, Access, Arr, Assign, AsyncCall, Base, Block, Call, Class, Closure, Code, CodeFragment, Comment, Existence, Extends, Flows, For, IDENTIFIER, IDENTIFIER_STR, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, NEGATE, NO, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, last, locationDataToString, merge, multident, puts, some, starts, throwSyntaxError, uid, unfoldSoak, utility, _ref, _ref1, _ref2, _ref3,
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.asyncCompileNode = function(o) {
      var dest, next, next_code, next_name, node, _ref2;
      return this;
      dest = [];
      while (node = this.expressions.shift()) {
        if (node.next && ((_ref2 = node.constructor.name) === 'For' || _ref2 === 'If' || _ref2 === 'While')) {
    ...
    Block.prototype.pop_next_code = function(flow, idx) {
      var block, code;
      block = new Block(this.expressions.splice(idx + 1));
  ...
  exports.If = If = (function(_super) {
    ...
    If.prototype.move = function(dest, next_body) {
      var body, call, next, next_fn, _i, _len, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (next_body == null) {
        next_body = null;
      }
      if (!this.async) {
      ...
      if ((this.autocb || next_body) && this.body.async) {
      ...
      dest.push(this);
      if (next_body) {
        if (((_ref6 = this.body) != null ? _ref6.async : void 0) || ((_ref7 = this.elseBody) != null ? _ref7.async : void 0)) {
          ...
          dest.push.apply(dest, next_body);
        }
      }
      this.async = false;
      return null;
