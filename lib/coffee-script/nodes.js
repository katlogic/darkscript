...
(function() {
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.makeReturn = function(res) {
      ...
      while (len--) {
        ...
        if (!(expr instanceof Comment)) {
          ...
          if (expr instanceof Return && !expr.expression.length && !this.autocb) {
    ...
    Block.prototype.asyncCompileNode = function(o) {
      ...
      for (index = _i = 0, _len = _ref2.length; _i < _len; index = ++_i) {
        ...
        if (node instanceof Await) {
          node.next_code = this.pop_next_code(o, index);
          break;
        } else if (node.async && ((_ref3 = node.constructor.name) === 'For' || _ref3 === 'If' || _ref3 === 'While')) {
          next_code = this.pop_next_code(o, index);
    ...
    Block.prototype.pop_next_code = function(o, idx) {
      var block, code;
  ...
  exports.While = While = (function(_super) {
    ...
    While.prototype.compileNode = function(o) {
      ...
      if (this.async) {
        return this.asyncCompileNode(o);
      }
      o.indent += TAB;
      set = '';
      body = this.body;
    ...
    While.prototype.asyncCompileNode = function(o) {
      var block, body, body_code, body_name, call, cond_check, next_name, ret, scope, step, step_code, step_name;
      scope = o.scope;
      ...
      body.setFlags();
      body.sync(this);
      cond_check = new If(this.condition, body);
      if (this.next != null) {
        next_name = this.next.name;
      } else {
      ...
      body_code = new Code([new Param(new Literal('autocb'))], new Block([cond_check]), 'boundfunc');
      body = new Assign(body_name, body_code);
      step_code = new Code([], new Block([new Call(body_name, [step_name])]));
      step = new Assign(step_name, step_code);
      block = Block.wrap([step, body, new Call(body_name, [step_name])]);
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.compileNode = function(o) {
      var body, bodyFragments, compare, compareDown, declare, declareDown, defPart, defPartFragments, down, flow, forPartFragments, guardPart, idt1, increment, index, info, ivar, kvar, kvarAssign, lastJumps, lvar, name, namePart, next, ref, resultPart, returnResult, rvar, scope, source, step, stepNum, stepVar, svar, varPart, _ref4, _ref5;
      flow = o.flows.last();
    ...
    For.prototype.asyncCompileNode = function(o, info) {
      var answer, block, blocks, body, body_code, body_fn, body_name, body_value, call, done_code, done_fn, done_name, done_value, flow, ifPart, init_name, init_value, next_name, next_value, return_fn, return_name, return_value, scope, step_code, step_fn, step_name, step_value, varPart;
      if (this.flow) {
        o.flows.push(this.flow);
      }
      answer = [];
      ...
      step_code = new Code([], new Block([new Literal(info.stepPart), new Call(body_value, [step_value])]));
      ...
      answer.push(this.makeCode("\n"));
      o.flows.pop();
      block = Block.wrap([new Literal(info.initPart), body_fn, new Call(body_value, [step_value])]);
      if (return_fn) {
  ...
  exports.If = If = (function(_super) {
    ...
    If.prototype.compileNode = function(o) {
      ...
      this.asyncCompileNode(o);
      rt = this.isStatement(o) ? this.compileStatement(o) : this.compileExpression(o);
      if (this.flow) {
        o.flows.pop();
      }
      return rt;
