...
(function() {
  var Assign, Block, CoffeeScript, Literal, Value, fs, merge, nodeREPL, path, prettyErrorMessage, replDefaults, vm, _ref, _ref1;
  ...
  function addMultilineHandler(repl) {
    var inputStream, multiline, nodeLineListener, origPrompt, outputStream, rli, _ref2;
    rli = repl.rli, inputStream = repl.inputStream, outputStream = repl.outputStream;
    origPrompt = (_ref2 = repl._prompt) != null ? _ref2 : repl.prompt;
    multiline = {
      enabled: false,
