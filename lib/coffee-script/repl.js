...
(function() {
  var Assign, Block, CoffeeScript, Literal, Value, addHistory, addMultilineHandler, fs, merge, nodeREPL, path, prettyErrorMessage, replDefaults, vm, _ref, _ref1;
    ...
    return repl.commands['.history'] = {
      ...
      action: function() {
        ...
        history = ((function() {
          ...
          _ref2 = Object.keys(repl.rli.history);
          _results = [];
