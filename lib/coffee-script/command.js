...
(function() {
  var BANNER, CoffeeScript, EventEmitter, SWITCHES, exec, fs, helpers, joinTimeout, mkdirp, notSources, optionParser, optparse, opts, path, sourceCode, sources, spawn, useWinPathSep, watchedDirs, _ref,
  ...
  function watch(source, base) {
    var compileTimeout, err, prevStats, watcher;
    watcher = null;
    prevStats = null;
    compileTimeout = null;
  ...
  function watchDir(source, base) {
    var err, readdirTimeout, watcher;
    watcher = null;
    readdirTimeout = null;
    function startWatcher() {
