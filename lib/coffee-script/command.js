...
(function() {
  var BANNER, CoffeeScript, EventEmitter, SWITCHES, exec, exists, fs, helpers, joinTimeout, notSources, optionParser, optparse, opts, path, sourceCode, sources, spawn, useWinPathSep, watchers, _ref;
  ...
  function watch(source, base) {
    var compileTimeout, e, prevStats, rewatch, watcher;
    prevStats = null;
    compileTimeout = null;
    function watchErr(e) {
      if (e.code === 'ENOENT') {
  ...
  function unwatchDir(source, base) {
  ...
  function removeSource(source, base, removeJs) {
    var index, jsPath;
    index = sources.indexOf(source);
  ...
  function writeJs(base, sourcePath, js, jsPath, generatedSourceMap) {
