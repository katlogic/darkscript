...
(function() {
  ...
  compilePath = function(source, topLevel, base) {
    return fs.stat(source, function(err, stats) {
      ...
      } else if (topLevel || path.extname(source).match(/^.*\.(iced|coffee)$/)) {
