...
(function() {
  var Lexer, Macro, SourceMap, compile, ext, fs, helpers, lexer, parser, path, sourceMaps, vm, _base, _i, _len, _ref,
  ...
  exports.compile = compile = function(code, options) {
    var ast, fragment, fragments, header, js, sourceMap;
    if (options == null) {
      options = {};
    }
    ...
    if (options.macros) {
      ast = new parser.yy.Block([
        exports.nodes(options.macros, {
          filename: 'macros'
        }), ast
      ]);
    }
  ...
  parser.yy.parseError = function(message, _arg) {
    ...
    if (!errorToken) {
      helpers.throwSyntaxError(message);
    }
  ...
  function formatSourcePosition(frame, defSrcMap) {
