...
(function() {
  var Lexer, Module, SourceMap, child_process, compile, ext, extensions, findExtension, fork, fs, helpers, lexer, parser, path, sourceMaps, vm, _i, _len,
  ...
  exports.VERSION = '1.6.3-3';

  extensions = ['.coffee', '.litcoffee', '.coffee.md', '.toffee'];
  ...
  exports.compile = compile = function(code, options) {
    ...
    if (options.header) {
      header = "Generated by ToffeeScript " + this.VERSION;
      js = "// " + header + "\n" + js;
    }
    if (options.sourceMap) {
      answer = {
  ...
  function compileFile(filename, sourceMap) {
  ...
  function formatSourcePosition(frame, getSourceMapping) {
  ...
  function getSourceMap(filename) {
    ...
    if (_ref = path != null ? path.extname(filename) : void 0, __indexOf.call(extensions, _ref) < 0) {
      return;
    }
  ...
  Error.prepareStackTrace = function(err, stack) {
    ...
    function getSourceMapping(filename, line, column) {
