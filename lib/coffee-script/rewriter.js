(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.rewriteAsynchronous = function() {
      var asyncParams, asyncTokens, closeCallback, i, id, indent, indents, isAsyncToken, len, length, line, m, params, pushAsyncParams, pushToken, pushTokens, tag, token, updateAsyncParams;
      asyncTokens = [];
      asyncParams = [];
      line = 0;
      i = 0;
      ...
      for (i = 0; 0 <= length ? i < length : i > length; 0 <= length ? i++ : i--) {
        ...
        switch (tag) {
          case '[':
            ...
            break;
          case '=':
            if (!isAsyncToken(this.tokens[i + 1])) {
              pushAsyncParams();
          ...
          case 'CALL_END':
            ...
            if (indent && indent === 'OPEN_CALLBACK') {
              indent = indents.pop();
              params = indents.pop();
