  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.rewriteAsynchronous = function() {
      ...
      updateAsyncParams = function() {
        ...
        } else if (tokens.length >= 2 && tokens[0][0] === '[' && tokens[last][0] === ']') {
          tokens[0] = ['PARAM_START', '(', tokens[0][2]];
          return tokens[last] = ['PARAM_END', ')', tokens[last][2]];
        } else if (tokens.length === 0) {} else {
      ...
      closeCallback = function() {
        var len;
        if (indents[indents.length - 1] && indents[indents.length - 1] === 'CLOSE_CALLBACK') {
          ...
          case '=':
            ...
            while (true) {
              ...
              if (stacks.length === 0 && isAsyncToken(token)) {
                ...
                stacks.pop(token);
              } else if (stacks.length > 0) {} else if ((_ref3 = token[0]) === 'IDENTIFIER' || _ref3 === '.' || _ref3 === '?.' || _ref3 === '::') {} else {
                pushAsyncParams();
