...
(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.rewriteAsync = function() {
      var caller, dest, end, ident, level, line, num, params, t, tag_await, tag_ce, tag_comma, tag_cs, tag_defer, token, tokens, _i, _j, _len, _len1, _ref, _ref1, _ref2;
      ident = ['IDENTIFIER', ',', '@', '.', '::'];
      dest = [];
      tokens = this.tokens;
      while (token = tokens.shift()) {
        if (token[0] === 'DEFER' && ((_ref = tokens[0]) != null ? _ref[0] : void 0) !== 'CALL_START') {
          line = token[2];
          dest.push.apply(dest, [token, ['CALL_START', '(', line], ['CALL_END', ')', line]]);
          ...
          if (t && t[0] === '=') {
            while ((t = dest.pop()) && (_ref2 = t[0], __indexOf.call(ident, _ref2) >= 0)) {
              params.unshift(t);
            }
          }
          if (t) {
  ...
  IMPLICIT_CALL = ['IDENTIFIER', 'NUMBER', 'STRING', 'JS', 'REGEX', 'NEW', 'PARAM_START', 'CLASS', 'IF', 'TRY', 'SWITCH', 'THIS', 'BOOL', 'NULL', 'UNDEFINED', 'UNARY', 'SUPER', 'THROW', '@', '->', '=>', '[', '(', '{', '--', '++', 'DEFER'];
